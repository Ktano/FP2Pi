...
def pede_jogada(tabuleiro):
    ...
    def jogada_valida(coord,val):
        """
        funcao auxiliar que recebe como argumento uma string
        (de acordo com as especificacoes) e um valor (celula em branco/caixa)
        verifica a validade dos dados inseridos pelo utilizador 
        """
